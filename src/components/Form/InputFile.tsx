  ...
  return (
    ...
    <div className={`input-group ${containerClass}`}>
      ...
      <div className="custom-file">
        <input type="file" className="custom-file-input" id="upload-file" aria-describedby="upload"/>
        <label className="custom-file-label" htmlFor="upload-file">Choose file</label>
      </div>
    </div>
  </>
  );
