    ...
    <>
      <section className="banner">
        ...
        <div className="banner-conent container text-white text-center">
          ...
          <div className="banner-text mb-3">We build health ecosystems which no one else has dared to build.</div>
          ...
          <div className="row align-items-center">
            <div className="col-md-6 animated fadeIn">
              <div className="wrapper">
                ...
                <p>Thuocsi.vn is the leading e-commerce healthcare e-commerce platform in Vietnam. 
                  The platform serves healthcare practices including pharmacies, clinics and hospitals 
