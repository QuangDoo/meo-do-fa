...
function Career (props): JSX.Element {
  ...
  const onFilter = (key) => {
    let temp = jobs.filter(job => job.jobName.toLowerCase().indexOf(key?.toLowerCase()) !== -1)
    setTempJobs(temp)
  }
      ...
      <div className="container">
        <div className="row">
          <div className="col text-center m-5">
            ...
            <a href="mailto:recruitment@thuocsi.vn" className="btn btn-primary">Email us now</a>
          </div>
        </div>
      </div>
    </>
