    ...
    <section className="bg-white text-center py-5 home__in-the-news">
      <div className="container">
        ...
        <div className="row in-the-news__items">
          ...
          <div className="col-sm-3 col-6 in-the-news__item">
            <a
              href="https://investglobal.vn/tin-tuc/startup-phan-phoi-duoc-pham-truc-tuyen-rockland-duoc-dau-tu-500-000-usd-tu-2-quy-dau-tu-183.html"
              rel="nofollow noreferrer"
              target="_blank">
              <img
                alt="Invest Global"
          ...
          <div className="col-sm-3 col-6 in-the-news__item">
            <a
              href="https://forbesvietnam.com.vn/tin-cap-nhat/rockland-startup-muon-giam-tinh-trang-thuoc-gia-nhan-von-500000-usd-7709.html"
              rel="nofollow noreferrer"
              target="_blank">
              <img
                alt="Forbes Vietnam"
          ...
          <div className="col-sm-3 col-6 in-the-news__item">
            <a
              href="https://e27.co/vietnamese-online-pharma-marketplace-medofa-vn-secures-us500k-from-cocoon-capital-vietcapital-ventures-20190926/"
              rel="nofollow noreferrer"
              target="_blank">
              <img
