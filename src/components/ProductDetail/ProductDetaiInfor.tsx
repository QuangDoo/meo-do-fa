        ...
        <div className="col-md-8"><div className="row">
                ...
                <div className="mb-3">
                    <small className="text-muted">
                        <span className="mr-3">
                            ...
                            <strong>7</strong>lượt xem</span>
                        <span>
                            <i className="icomoon icon-shopping mr-1" />
                            <strong>0</strong> lượt mua trong 24 giờ qua</span>
                    </small>
                </div>
                <hr />
                <div className="mb-3">
                    <Link href="/login">
                    <a className="btn btn-sm btn-secondary" data-modal="true">Đăng nhập để xem giá</a>
                    </Link>
            ...
            <div className="col-md-5">
                <div className="product__suppliers">
                    <p>Hệ thống sẽ chọn nhà cung cấp tốt nhất cho bạn.
                 <a data-modal="true" href="/terms-and-condition">Điều Khoản Sử Dụng</a>
                    </p>
                    <hr />
                    <div className="d-flex justify-content-between align-items-center">Đăng ký bán hàng cùng thuocsi.vn
